...
describe('tests for config-file.util', () => {
  it('should export configFileDataManager, fileDataManager, getFilePath, doesItExist, fileOrFolder, getFilesInDirectory', () => {
    ...
    expect(exported['getFilesInDirectory']).toBeTruthy();
  });
});
